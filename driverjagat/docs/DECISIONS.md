...
**D-035 · রোজকার মেয়াদ - `validUntil` লেখা হতো, কেউ পড়ত না।**
Payment এর transaction এ `validUntil` বসত ঠিকই, কিন্তু কোনো code
কোনোদিন ওটা পড়ত না। মানে একবার প্রকাশ হলে post **চিরকাল** feed এ
থাকত: ড্রাইভার ফোন করেন, মালিক বলেন "ঐ কাজ তো তিন মাস আগে ভরে
গেছে" - দুই পক্ষই ভরসা হারান। Facebook group গুলোর এক নম্বর রোগটাই
এটা, আর আমাদের একমাত্র দাবি হলো feed এ যা আছে তা **সত্যি খালি**।
`expireJobs()` এখন `stage == published` + `validUntil <= এখন` দেখে
`expired` করে। **শুধু published** - `shortlisted` বা `onboarding`
মানে admin তখন দুই পক্ষের সাথে কথা বলছেন, মাঝখানে মেয়াদ শেষ করলে
একটা চলতি আলোচনা ভেঙে যেত।

**D-036 · Approve করে টাকা না দিলে ৭ দিনে বাতিল।**
`approvedUnpaidExpiryDays: 7` config এ ছিল, কোথাও ব্যবহার হতো না -
মানে "approve করে রাখি, টাকা পরে দেব" একটা স্থায়ী অবস্থা হয়ে যেত।
এখন `approvedAt` মুছে যায়, job **pending** এ ফিরে যায় (মুছে ফেলা
হয় না - মালিক পরে এলে admin আবার একবার দেখে অনুমোদন দেবেন, শুরু
থেকে করতে হয় না)। ⚠️ `verified` মালিককে নামানো হয় **না** (D-013):
এক মালিকের একাধিক post থাকতে পারে, একটার fee বাকিতে মেয়াদ শেষ
হলেও আগের post গুলো তো ঠিকই আছে।

`approvedUnpaidReminderDays: 3` **এখনো ব্যবহার হয় না** - এই app এ
SMS এর কোনো পথ নেই। পথটা বসলে `expireApprovedUnpaid()` এর ভিতরেই
মনে করিয়ে দেওয়া বসবে। খোলা রাখা হলো, কারণ অর্ধেক ফিচার বানিয়ে
"হয়ে গেছে" বলার চেয়ে না-বানানো ভালো।

**যাচাই:** e2e তে সত্যিকারের একটা মেয়াদোত্তীর্ণ job বানিয়ে দেখা
হয় জাল সেটা feed থেকে নামায় কিনা, আর একটা `shortlisted` রেখে দেখা
হয় সে ওটা ছোঁয় না; ৮ দিনের পুরনো approval বাতিল হয়, আজকেরটা হয় না।
`check:config` এ নতুন assert - config এ সংখ্যা লেখা থাকা আর সেটা
**কাজ করা** এক জিনিস না, তাই `lifecycle.ts` সত্যি ঐ সংখ্যাগুলো
পড়ে কিনা মেপে দেখা হয়। Index লাগল `jobs (stage, validUntil)` আর
`jobs (stage, approvedAt)`।
